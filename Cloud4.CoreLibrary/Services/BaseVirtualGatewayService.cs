...
{
    public class BaseVirtualGatewayService<T,Y,Z> : IBaseServiceInterface<T>, IBaseCreateServiceInterface<Y>, IBaseUpdateServiceInterface<Z>
    {
        ...
        protected Guid VirtualGatewayId { get; set; }

        public BaseVirtualGatewayService()
        {

        }
        public BaseVirtualGatewayService(Connection con, Guid VirtualGatewayId)
        {
        ...
        public virtual async Task<Result<List<T>>> AllAsync()
        {
            ...
            var result = await client.GetDataAsJsonAsync<List<T>>( new Uri( this.Connection.ApiUrl , this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualGatewayId.ToString() + "/" + SubEntity));
        ...
        public virtual async Task<Result<T>> GetAsync(Guid Id)
        {
            ...
            var result = await client.GetDataAsJsonAsync<T>( new Uri( this.Connection.ApiUrl , this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualGatewayId.ToString() + "/" + SubEntity + "/" + Id.ToString()));
        ...
        public virtual async Task<Result> CreateAsync(Y body)
        {
            ...
            DataClientResult result = await client.PostDataAsJsonAsync<Y>( this.Connection.ApiUrl + this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualGatewayId.ToString() + "/" + SubEntity, body);
        ...
        {
            Result returnresult = new Result();
            DataClientResult result = await client.PutDataAsJsonAsync<Z>(new Uri(this.Connection.ApiUrl, this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualGatewayId.ToString() + "/" + SubEntity + "/" + Id.ToString()), body);
        ...
        {
            Result returnresult = new Result();
            DataClientResult result = await client.DeleteDataAsJsonAsync(new Uri(this.Connection.ApiUrl, this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualGatewayId.ToString() + "/" + SubEntity + "/" + Id.ToString()));
