...
{
    public class BaseVirtualFirewallService<T,Y,Z> : IBaseServiceInterface<T>, IBaseCreateServiceInterface<Y>, IBaseUpdateServiceInterface<Z>
    {
        ...
        protected Guid VirtualFirewallId { get; set; }

        public BaseVirtualFirewallService()
        {

        }
        public BaseVirtualFirewallService(Connection con, Guid VirtualFirewallId)
        {
            client = new ResourceDataClient();
            client.Connection = con;
            this.Connection = con;
            this.VirtualFirewallId = VirtualFirewallId;
        ...
        public virtual async Task<Result<List<T>>> AllAsync()
        {
            ...
            var result = await client.GetDataAsJsonAsync<List<T>>( new Uri( this.Connection.ApiUrl , this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualFirewallId.ToString() + "/" + SubEntity));
        ...
        public virtual async Task<Result<T>> GetAsync(Guid Id)
        {
            ...
            var result = await client.GetDataAsJsonAsync<T>( new Uri( this.Connection.ApiUrl , this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualFirewallId.ToString() + "/" + SubEntity + "/" + Id.ToString()));
        ...
        public virtual async Task<Result> CreateAsync(Y body)
        {
            ...
            DataClientResult result = await client.PostDataAsJsonAsync<Y>( this.Connection.ApiUrl + this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualFirewallId.ToString() + "/" + SubEntity, body);
        ...
        {
            Result returnresult = new Result();
            DataClientResult result = await client.PutDataAsJsonAsync<Z>(new Uri(this.Connection.ApiUrl, this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualFirewallId.ToString() + "/" + SubEntity + "/" + Id.ToString()), body);
        ...
        {
            Result returnresult = new Result();
            DataClientResult result = await client.DeleteDataAsJsonAsync(new Uri(this.Connection.ApiUrl, this.Connection.TenantId.ToString() + "/" + Entity + "/" + VirtualFirewallId.ToString() + "/" + SubEntity + "/" + Id.ToString()));
