...
$vdc = New-Cloud4vDC -Name "Demo vDC" -RegionId 1e10c132-9e10-40f9-862e-037d01d21d79 -Wait $true
...
$vnet = New-Cloud4vNet -Name "Demo vNet" -AddressSpace "192.168.0.0/16" -VirtualDataCenterId $vdc.Id -SubNet $subnets -DNSServers 8.8.8.8,8.8.4.4 -Wait $true

$vdc = Get-Cloud4vDC -FilterByName "Erlis vDC"
...
$vm = New-Cloud4VM -Name "DEMOVM1" -VirtualDatacenterId $vdc.Id -VirtualSubNetId $vsubnetid -ImageId 1fe08740-c31b-4773-8166-5e92552990e2 -VMProfile F8v1 -OSDiskProfile S60 -NICProfile 100Mbps -OSSettings $ossettings -EnableRemoteAccess $true -EnableInternetAccess $true -EnableInOutboundVNetTraffic $true 
