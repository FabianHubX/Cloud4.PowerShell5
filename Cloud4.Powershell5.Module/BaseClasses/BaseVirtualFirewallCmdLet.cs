...
{
    public class BaseVirtualFirewallCmdLet<T,Y>: Cmdlet
    {
        ...
        public T WaitJobFinished(Guid jobid, Connection con, Guid VirtualGatewayId)
        {
        ...
        public static T Get(Connection con, Guid Id, Guid VirtualGatewayId)
        {
            var service = Activator.CreateInstance(typeof(Y), new object[] { con, VirtualGatewayId });
