...
{
    public class BaseLoadBalancerCmdLet<T,Y>: Cmdlet
    {
        ...
        public T WaitJobFinished(Guid jobid, Connection con, Guid VirtualLoadBalancerId)
        {
        ...
        public static T Get(Connection con, Guid Id, Guid VirtualLoadBalancerId)
        {
            var service = Activator.CreateInstance(typeof(Y), new object[] { con, VirtualLoadBalancerId });
