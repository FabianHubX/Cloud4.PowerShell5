...
namespace Cloud4.Powershell5.Module
{
    ...
    public class BaseVirtualFirewallRemoveCmdLet<T,Y> : BaseVirtualFirewallCmdLet<T,Y> where Y : new()
    {
        ...
        public static CoreLibrary.Models.Job Remove(Guid Id, Connection con, Guid VirtualGatewayId, bool Wait)
        {
